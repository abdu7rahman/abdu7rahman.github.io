...
# index.html is the lab now and is generated by Vite, which does its own
# content hashing; the hand-written pages are the ones that need stamping.
PAGES = ("written.html", "demo.html", "404.html", "admin.html")
