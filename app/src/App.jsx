    ...
    <>
      <Canvas
        ...
        onCreated={({ gl, scene }) => {
           ...
           * plane converged on near black: at 67.7 m the far end of the lane
           * is 82 per cent of the way through the mix, which is to say the
           ...
           * it, not darker -- which is also what makes 67.7 m of depth
           * legible as depth.
           *
